    ...
    <main className="min-h-screen bg-[#21150e] text-white">
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        <div className="bg-[#2d1d13] border border-white/10 rounded-[3rem] p-10">
          ...
          <h1 className="text-5xl font-black mb-5">Pago pendiente</h1>
          <p className="text-zinc-400 text-lg mb-8">El pago quedó pendiente de confirmación. Te avisaremos cuando se actualice el estado.</p>
