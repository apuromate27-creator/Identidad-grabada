...
export function CommercialSections() {
  return (
    <>
      <section id="como-trabajamos" className="border-y border-white/10 bg-[#090909] py-24">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr]">
          <div className="rounded-[3rem] border border-white/10 bg-[#0b0b0b] p-10 md:p-14">
          ...
          <div className="rounded-[3rem] bg-[#b68b52] p-10 text-black md:p-14">
            ...
            <Link
              href="/empresas"
              className="mt-8 inline-block rounded-2xl bg-black px-8 py-5 font-black text-white"
            >
