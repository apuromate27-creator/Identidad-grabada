...
export function TrustStrip() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-12">
      <div className="ig-soft-glow grid gap-4 rounded-[2.5rem] border border-[#b68b52]/20 bg-[#2a1a10]/45 p-5 md:grid-cols-4">
        {items.map(([title, text], index) => (
          <div
            key={title}
            className="rounded-2xl border border-white/10 bg-[#1d130d]/45/30 p-5"
          >
