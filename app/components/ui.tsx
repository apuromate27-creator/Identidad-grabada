...
export function InfoBox({title,text}:{title:string;text:string}){return <div className="bg-[#1d130d]/40 border border-white/10 rounded-2xl p-5"><p className="text-zinc-500 text-xs uppercase tracking-[0.2em] mb-2">{title}</p><p className="font-bold">{text}</p></div>}
