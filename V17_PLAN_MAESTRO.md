...
- Fondos diferenciados para escritorio y celular.
- Fondo específico por ruta.
- Sistema global de transparencias.
- Tarjetas, formularios y paneles con efecto vidrio.
- Menor opacidad en móvil para mostrar mejor el paisaje.
